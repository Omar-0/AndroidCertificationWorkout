...
package com.axiasoft.mycertificationworkout.views.basicandroidaccessibility;
...
public class AccessabilityMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast toast = Toast.makeText(getApplicationContext(), "Install and enable Android Talkback to test", Toast.LENGTH_LONG);
        toast.show();
    }
    ...
    public void launchActivity(final View view) {
        ...
        if (klass != null) {
            startActivity(new Intent(AccessabilityMainActivity.this, klass));
        }
    }
}
